...
public class QuadMesh : MonoBehaviour
{
    ...
    {
        vertices[0] = new Vector3(-offset, offset, 0);  //ADC
        vertices[1] = new Vector3(offset, -offset, 0);
        vertices[2] = new Vector3(-offset, -offset, 0);
        vertices[3] = new Vector3(-offset, offset, 0);  //ABD
        vertices[4] = new Vector3(offset, offset, 0);
        vertices[5] = new Vector3(offset, -offset, 0);
        ...
        uv[0] = new Vector3(0, 1);  //ADC
        uv[1] = new Vector3(1, 0);
        uv[2] = new Vector3(0, 0);
        uv[3] = new Vector3(0, 1);  //ABD
        uv[4] = new Vector3(1, 1);
        uv[5] = new Vector3(1, 0);
    }
